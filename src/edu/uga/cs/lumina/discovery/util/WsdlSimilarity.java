...
public class WsdlSimilarity {
    ...
    public static double oPSim(WsOpReader req, WsOpReader ws) throws Exception {
    	...
    	if (DEBUG) System.out.println("inSim = " + inSim);
    	if (DEBUG) System.out.println("outSim = " + outSim);
    	if (DEBUG) System.out.println("nameSyn = " + nameSyn);
    	if (DEBUG) System.out.println("funSim = " + funSim);
