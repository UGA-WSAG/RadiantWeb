...
public class LoadOWL extends ActionSupport {
	...
	public String execute() {
		...
		System.out.println("owlloc = " + owlloc);
		if (OWLFile != null) System.out.println("OWLFile size = " + OWLFile.getTotalSpace());
		...
		try {
			...
			if (owlloc.indexOf("http:") != -1){	
	        	...
	        	if (OWLFile != null){
	        		...
	        		if (owlloc.endsWith(extension) || owlloc.endsWith(extension1)){
	    				...
	    				System.out.println("THe owl path is : * " + owlPath);
			...
			if (errormsg.equals("") && (mgr != null)){
		    	...
		    	//System.out.println("classes_hierarchy = " + classes_hierarchy);
		    	
			}else{
				if (errormsg.equals("")) errormsg = "Ontology load fails.";
				if (tabIndex.equals("0")){
					session.remove("OntologyManager");
					System.out.println("remove OntologyManager");
				}else{
					session.remove("OntologyManager" + tabIndex);
					System.out.println("remove OntologyManager" + tabIndex);
				}
			}
		...
		System.out.println("OntologyManager = " + (OntologyManager) session.get("OntologyManager"));
		System.out.println("OntologyManager1 = " + (OntologyManager) session.get("OntologyManager1"));
		System.out.println("OntologyManager2 = " + (OntologyManager) session.get("OntologyManager2"));
