...
public class Restriction {
    ...
    public static OWLClassExpression seekIntersectionOrUnion(OWLClassExpression parent) {
    ...
    public static Set<Restriction> getRestrictions(OWLClass cls, String owlURI) throws OWLOntologyCreationException, IOException {
        OntologyManager parser = OntologyManager.getInstance(owlURI);

        Set<OWLClassExpression> clsSupers = OntologyManager.getDirectSuperExpression(cls, parser);
...
*/
    public static void main(String[] args) throws IOException, OWLOntologyCreationException {
        ...
        Set<OWLClassExpression> supers = OntologyManager.getDirectSuperExpression(test, discoveryMgr);
