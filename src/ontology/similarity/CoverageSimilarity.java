...
public class CoverageSimilarity {
     ...
     */
    public static int getConceptPathLength (OWLClass Cst, OWLClass Ccs, String owlURI) throws OWLOntologyCreationException, IOException 
    {    
    ...
    public static double getCvrgSimScore(OWLClass Cst, OWLClass Ccs, String owlURI) throws OWLOntologyCreationException, IOException
    {
