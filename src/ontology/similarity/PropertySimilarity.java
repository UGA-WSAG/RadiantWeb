...
import edu.uga.radiant.ontology.Restriction;
...
public class PropertySimilarity {
     ...
     */
    private static double propSynSim (OWLProperty Pst, OWLProperty Pcs, String owlURI) throws OWLOntologyCreationException, IOException 
    {
        double common = 0.0;
     ...
     * @throws OWLOntologyCreationException 
     */
    private static double cardinalitySim (OWLProperty Pst, OWLProperty Pcs, String owlURI) throws OWLOntologyCreationException, IOException
    {
        OntologyManager parser = OntologyManager.getInstance(owlURI);
     ...
     * @throws OWLOntologyCreationException 
     */
    private static double rangeSim (OWLProperty Pst, OWLProperty Pcs, OWLClass Cst, OWLClass Ccs, String owlURI) throws OWLOntologyCreationException, IOException
    {
        ...
        if (PstRestrictionClassSet.isEmpty()) {
        	...
        	if (Pst.isObjectPropertyExpression()){
        		PstRangeSet = parser.getRanges(Pst);
            }
        ...
        if (PcsRestrictionClassSet.isEmpty()) {
        	...
        	if (Pcs.isObjectPropertyExpression()){
        		PcsRangeSet = parser.getRanges(Pcs);
     ...
     * @throws OWLOntologyCreationException 
     */
    private static double synSim(OWLProperty Pst, OWLProperty Pcs, String owlURI) throws OWLOntologyCreationException, IOException 
    {
        OntologyManager parser = OntologyManager.getInstance(owlURI);
    ...
    private static double restrictionMatch(OWLClass Cst, OWLClass Ccs, String owlURI) throws OWLOntologyCreationException, IOException 
    {
        OntologyManager parser = OntologyManager.getInstance(owlURI);
     ...
     * @throws OWLOntologyCreationException 
     */
    private static double propMatch(OWLProperty Pst, OWLProperty Pcs, OWLClass Cst, OWLClass Ccs, String owlURI) throws OWLOntologyCreationException, IOException 
    {
        OntologyManager parser = OntologyManager.getInstance(owlURI);
     ...
     * 
     */
    public static double getPropertySimScore(OWLClass Cst, OWLClass Ccs, String owlURI) throws OWLOntologyCreationException, IOException 
    {
        OntologyManager parser = OntologyManager.getInstance(owlURI);
