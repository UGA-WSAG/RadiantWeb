 ...
 */	
	 ...
	 */
	function remove(wsType, id, type, attr, value, divId){
	            ...
	            for (var i = 0; i < arr.length; i++) { 
	                ...
	                if (url != ''){
	                	...
	                	obj.innerHTML = content + '<div id="' + divName + '" name="' + divName + '" style="margin:10px" ><span class="annotated ui-widget-content ui-corner-all hove"><b>' + attr + " : " + url + '</b></span>' + 
										'<span class="hove ui-icon ui-icon-close" style="float:left" onclick="remove(' + id + ', \'' + type + '\', \'' + attr  + '\' , \'' + url + '\', \'' + divName + '\');"><b> X </b></span></div>' ;
	                }
	            }
			}else{
				alert(errormsg);
	            ...
	            for (var i = 0; i < arr.length; i++) { 
	                ...
	                if (iri != ''){
	                	...
	                	if (id != 0){
							...
							'<span class="hove ui-icon ui-icon-close" style="float:left" onclick="remove(\'wsdl\', ' + id + ', \'' + type + '\', \'' + attr  + '\' , \'' + iri + '\', \'' + divId + '\');"><b> X </b></span></div>' ;
	                	}else{
	                		obj.innerHTML = content + '<div id="' + divId + '" name="' + divName + '" style="margin:10px" ><span class="annotated ui-widget-content ui-corner-all hove" onclick="openOWLNode(\'' + owlid + '\')"><b>' + label + '</b></span>' + 
							'<span class="hove ui-icon ui-icon-close" style="float:left" onclick="remove(\'wadl\', \'' + name + '\', \'' + type + '\', \'' + attr  + '\' , \'' + iri + '\', \'' + divId + '\');"><b> X </b></span></div>' ;
	                	}
	                }
	            }
			}else{
