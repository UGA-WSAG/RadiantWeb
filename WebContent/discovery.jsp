...
<script type="text/javascript">
	 ...
	 */
	 function remove(ele, type, concept){
	     var expression = '';
	     if (concept != null){
...
function addInputElement() {
	...
	var branches1 = $('<li id="input' + num + '"><div id="input' + num + 'drop" class="element drop ui-widget-content ui-corner-all ui-droppable" title="" >' +
						...
						' <span class="ui-button ui-corner-all" style="background:#616D7E; color:white; text-align: center; width: 20px; margin: 2px; padding:1px" onclick="remove(this, \'input\');"><b> X </b></span>' + 
...
function addOutputElement() {
	...
	var branches2 = $('<li id="output' + num + '">' +
						...
						' <span class="ui-button ui-corner-all" style="background:#616D7E; color:white; text-align: center; width: 20px; margin: 2px; padding:1px" onclick="remove(this, \'output\');"><b> X </b></span>' +
	...
	<script type="text/javascript" src="/Radiant/struts/js/base/jquery-1.7.1.min.js"></script>
	<script type="text/javascript" src="/Radiant/struts/js/base/jquery.ui.core.min.js?s2j=3.3.0"></script>
	<script type="text/javascript" src="/Radiant/struts/js/plugins/jquery.subscribe.min.js"></script>
	<script type="text/javascript" src="/Radiant/struts/js/struts2/jquery.struts2-3.3.0.min.js"></script>
...
<div id="main" style="width:98%; height:auto">
	<div style="float:right;"><a href="/Radiant/index.jsp">Home</a></div>
